...
| 1.13 | Experimental crisis-support truth | in both languages, submit a quoted/negated self-harm phrase, a direct first-person phrase, then confirm immediate danger; repeat with and without local `[crisis_support]` contacts | quoted/negated text does not false-trigger; direct text asks a plain safety question before rule/LLM output; immediate danger prioritizes company, safer means access and local help; no diagnosis, authority-notified claim or silent diary/timeline record appears; missing contacts are stated honestly |
