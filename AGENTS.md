...
# 测试
pytest tests/ -q                  # 全量测试；本机/CI 预期 616 passed + 6 skipped
...
- 622 项测试已收集；本机/CI 口径预期 616 passed + 6 skipped；受限 sandbox 当前口径 614 passed + 8 skipped，本地 TCP 网络项会显式 skip 或 regression `environment_blocked`
- Ruff lint 0 errors
